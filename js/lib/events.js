...
var _rrule = __webpack_require__(327);
                                            ...
                                            switch (_context.prev = _context.next) {
                                                ...
                                                case 17:
                                                    ...
                                                    theEvents.forEach(function (item) {
                                                        if (item.recurrence) {
                                                            var nextOneThisYear = (0, _rrule.rrulestr)(item.recurrence[0], { tzinfos: "CST" }).between(new Date(new Date().setHours(0, 0, 0, 0)), new Date("01/01/" + (new Date().getFullYear() + 1)))[0];
                                                            item.start.dateTime = new Date(nextOneThisYear).setHours(new Date(item.start.dateTime).getHours(), new Date(item.start.dateTime).getMinutes());
                                                        }
                                                    });
  ...
  function getnlp () {
    ...
    if (!getnlp._nlp) {
      if (root && root._getRRuleNLP) {
        ...
        getnlp._nlp = __webpack_require__(328)(RRule)
      } else {
